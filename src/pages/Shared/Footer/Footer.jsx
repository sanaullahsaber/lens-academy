...
const Footer = () => {
  return (
    <div className="bg-[#011522]">
      <div className="max-w-7xl mx-auto">
        <footer className="footer p-5  text-white">
          <div>
            <span className="footer-title">Contact Us</span>
            <a className="link link-hover">support@lensacademyschool.com</a>
            <a className="link link-hover">(800) 123-4567</a>
            <br />
            <a className="link link-hover">1234 Photography Street</a>
            <a className="link link-hover">City, State 12345</a>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="form-control w-80">
              ...
              <div className="relative">
                ...
                />
                <button className="btn btn-ghost bg-gray-600 absolute top-0 right-0 rounded-l-none">
                  Submit
                </button>
              </div>
            </div>
        ...
        <footer className="footer px-10 py-4 border-t text-white border-base-300">
          <div className="items-center grid-flow-col">
            {/* <img src={logo} alt="" /> */}
            <p>
              Photography School &copy; 2023. All rights reserved. <br />
              Designed and developed with 🖤 by Lens Academy
            </p>
          </div>
